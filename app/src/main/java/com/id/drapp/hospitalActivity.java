...
public class hospitalActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.aboutUs:
                ...
                String url = "http://169.254.88.200:8000/dashbord#";
                try {
    ...
    private void showAboutUsDialog() {
        ...
        String text = "Doctorave is a Complete app for Doctors and Patients. Developed by manthan m k . More Features Coming soon... <br><br>&emsp;<a href='https://github.com/manthan m k-'> Github </a> &emsp;" +
                "  <a href='https://in.linkedin.com/in/manthan m k--716b37145'> Linkedin </a> &emsp;  <a href='http://manthan m k-.me/'> Website </a>" +
                "<br><br><strong>Privacy and Policy / Open Source Licenses:</strong> <a href='http://manthan m k-.me/doctorave-privacy-policy'> Check Here. </a><br><br><Strong>Fork us on Github: </Strong><a href='https://github.com/manthan m k-/Doctorave'>Here. </a><br><br> If any Issue/Bug contact us here: <a href=\"mailto:gomanthan m k15@gmail.com?Subject=Hello%20again\" target=\"_top\">here</a>";
        textView.setText(Html.fromHtml(text));


        mMaterialDialog = new MaterialDialog(this)
                .setTitle("Doctorave")
                .setMessage("Doctorave is a Complete App for Doctors and Patient. Developed by manthan m k .")
