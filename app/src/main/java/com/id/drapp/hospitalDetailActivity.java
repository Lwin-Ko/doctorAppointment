...
public class hospitalDetailActivity extends AppCompatActivity {
    ...
    private Button getAppointment,seeLoc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeLoc=(Button)findViewById(R.id.getLocation);


        seeLoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent locit=new Intent(hospitalDetailActivity.this,MapsActivity.class);
                startActivity(locit);
            }
        });
                                                ...
                                                public void onSuccess(Void aVoid) {
                                                    ...
                                                    mDatabaseReference.setValue(new doctorAppointmentsModel(patientFullName.getText().toString().trim(),
                                                            ...
                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                ...
                                                                public void onSuccess(Void aVoid) {
                                                                    progressDialog.dismiss();
                                                                    Toast.makeText(hospitalDetailActivity.this, "Booked your Appointment please make payment to confirm", Toast.LENGTH_LONG).show();
                                                                    PackageManager pm=getPackageManager();
                                                                    Intent payintent=pm.getLaunchIntentForPackage("nimbl3.com.payumoneydemo");
                                                                    if(payintent!=null) {
